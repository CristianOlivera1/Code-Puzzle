document.addEventListener('DOMContentLoaded', function() {
    ...
    function init() {
        // Configurar modales existentes del HTML
        setupExistingModals();
    ...
    function setupExistingModals() {
        ...
        // Configurar selección de avatares predefinidos
        ...
        // Configurar botón guardar avatar
        ...
        // Agregar área de subida de archivos al modal de avatar
        addUploadAreaToModal();
    }

    function addUploadAreaToModal() {
        const avatarOptions = document.querySelector('.avatar-options');
        if (avatarOptions) {
            // Crear área de subida
            ...
            // Insertar antes de los avatares predefinidos
            const avatarGrid = document.querySelector('.avatar-grid');
            avatarOptions.insertBefore(uploadSection, avatarGrid);
