document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayUserStats(stats) {
        // Niveles completados
        const completedElement = document.querySelector('.stat-value[data-stat="completed"]');
        if (completedElement) {
        ...
        // Mejor tiempo
        const timeElement = document.querySelector('.stat-value[data-stat="time"]');
        if (timeElement) {
...
// Estilos CSS adicionales para los modales y notificaciones
